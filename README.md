...
* The "Lung masks" were sliced in the Z direction.
* The "Image Volumes" were sliced in the Z direction, and the slices were then segmentaed using one of the proposed segmentation method. 
